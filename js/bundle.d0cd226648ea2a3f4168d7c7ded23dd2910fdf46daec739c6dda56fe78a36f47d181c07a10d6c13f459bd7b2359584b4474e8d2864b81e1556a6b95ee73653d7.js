...
const parentURL = 'https://drayko.github.io/';
...
function fileClosure(){ 
  ...
  (function navToggle() {
    doc.addEventListener('click', function(event){
      ...
      const harmburgerIcon = 'https://drayko.github.io/icons/bar.svg';
      const closeIcon = 'https://drayko.github.io/icons/cancel.svg';
      if(isNavToggle) {
        event.preventDefault();
